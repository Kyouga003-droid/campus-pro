...
$book_count = getCount($conn, 'library');
...
<style>
    ...
    .rpg-card { 
        background: var(--card-bg); border: 2px solid var(--border-color); border-radius: 16px; padding: 30px 20px; 
        display: flex; flex-direction: column; align-items: center; text-align: center; 
        transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275); position: relative; overflow: hidden; text-decoration: none;
    ...
    /* Updated Title Layout matching image */
    ...
    .hero-banner { background: var(--sub-menu-bg); padding: 55px; border-radius: 20px; box-shadow: var(--soft-shadow); margin-bottom: 50px; position: relative; overflow: hidden; border: 2px solid var(--border-color); border-left: 12px solid var(--brand-secondary); }
    [data-theme="light"] .hero-banner { border-left-color: var(--brand-primary); }
    .hero-bg-art { position:absolute; right: -5%; top: -50%; opacity: 0.04; width: 450px; pointer-events: none; color: var(--text-dark);}
    
    /* Operations Grid matched to Image */
    ...
    /* New List Item styling for Tickets/Visitors/Metrics */
...
<div class="hero-banner">
    <svg class="hero-bg-art" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <polygon points="50,5 95,25 95,75 50,95 5,75 5,25" fill="currentColor"/>
    </svg>
    <div style="position:relative; z-index:2;">
        <h1 style="color: var(--text-dark); font-size:3.8rem; margin-bottom:15px; line-height: 1.1; font-style: italic;">
            <?= $greeting ?>, Admin.
        </h1>
        <p style="color: var(--text-light); font-weight: 600; font-size:1.3rem; letter-spacing: 0.5px; text-transform: uppercase;">Executive Command & Central Intelligence Matrix</p>
    </div>
</div>
